...
@hydra.main(version_base=None, config_path='./configs/train/single_task', config_name='reach_target_lang')
def main(cfg: DictConfig) -> None:
    ...
    text = []
    text.append('reach the red target')
    text.append('reach the green target')
    text.append('reach the blue target')
    # get embeddings
